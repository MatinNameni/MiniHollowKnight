...
public class KeyBindingsController {
    ...
    public KeyBindingsController(ScreenNavigator navigator, Settings settings, boolean cameFromPause) {
    ...
    /** Reopens the key bindings screen. */
    private void refreshKeyBindingsScreen() {
        if (cameFromPause) {
